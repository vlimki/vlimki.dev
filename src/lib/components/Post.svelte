...
<div class="mb-6">
	    ...
	    <h3 class="text-[#252525] !font-normal dark:text-[#fcfcfc]">{post.title}</h3>
  	  <p class="!my-0 !mb-1 text-[#666666] dark:text-[#999999] text-[14px] sm:text-[15px] leading-5 sm:leading-[1.4rem] md:text-sm">{post.description}</p>
		</a>
